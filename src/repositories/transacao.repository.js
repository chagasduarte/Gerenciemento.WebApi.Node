...
export const TransacaoRepository = {
  ...
  async listaDespesa(descricao, userid) {
    const query = `SELECT id, descricao, tipo, valor, categoria, TO_CHAR(t."data"::date, 'YYYY-MM-DD') AS data, status FROM transacoes t WHERE descricao like '%$1%' and userid = $2`;
